...
const PAGE_MUTED = '#F8FAFC';

const t = {
  transition: 'transition-all duration-200 ease-in-out',
  max: 'mx-auto max-w-6xl px-4 sm:px-6',
  body: 'text-lg leading-relaxed text-slate-500',
  /** Slate-800 aligns with warm slate #1E293B for headings */
...
function StarsFive({ className }: { className?: string }) {
  return (
    <div className={`flex gap-0.5 text-teal-500 ${className ?? ''}`} aria-hidden>
...
function HeroMockupIllustration() {
  return (
    <svg viewBox="0 0 320 280" className="h-auto w-full max-w-md" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <rect x="8" y="8" width="304" height="264" rx="16" fill={PAGE_WHITE} stroke="#E2E8F0" strokeWidth="2" />
      <rect x="28" y="28" width="120" height="10" rx="4" fill="#CBD5E1" />
      <rect x="28" y="48" width="200" height="8" rx="3" fill="#E2E8F0" />
      <rect x="28" y="64" width="160" height="8" rx="3" fill="#E2E8F0" />
      <rect x="28" y="96" width="264" height="72" rx="12" fill={TINT_BG} stroke="#99F6E4" strokeWidth="1" />
      <rect x="48" y="116" width="100" height="8" rx="3" fill="#0F766E" opacity="0.35" />
      <rect x="48" y="132" width="72" height="6" rx="2" fill="#94A3B8" />
      <circle cx="260" cy="132" r="14" fill="#0F766E" opacity="0.2" />
      <path d="M254 132l4 4 8-8" stroke="#0F766E" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="28" y="184" width="264" height="64" rx="12" fill="#F8FAFC" stroke="#E2E8F0" />
      <rect x="48" y="204" width="56" height="6" rx="2" fill="#CBD5E1" />
      <rect x="48" y="218" width="120" height="6" rx="2" fill="#E2E8F0" />
      <rect x="220" y="208" width="56" height="28" rx="6" fill="#0F766E" />
    </svg>
  );
}
...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] antialiased" style={{ color: BODY }}>
        ...
        <div className={`${t.max} flex flex-col gap-12 lg:flex-row lg:items-center lg:gap-16`}>
          <div className="w-full lg:w-[58%] lg:max-w-none">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
              ...
              <Link
                to="/login"
                className={`inline-flex items-center justify-center rounded-xl border-2 border-slate-200 bg-white px-6 py-3 text-center text-base font-semibold text-slate-700 ${t.transition} hover:scale-[1.02] hover:border-teal-300 active:scale-[0.98]`}
              >
                Log in
              </Link>
            </div>
      ...
      {/* Features */}
      <section id="features" className="scroll-mt-20 border-b border-slate-100 bg-[#FFFFFF] py-16 md:py-24">
        <div className={t.max}>
      ...
      {/* How it works */}
      <section className="relative border-b border-slate-100 py-16 md:py-24" style={{ backgroundColor: PAGE_MUTED }}>
        <div className={t.max}>
          ...
          <div className="relative mt-16 hidden md:block">
            <div className="absolute left-[8%] right-[8%] top-8 border-t-2 border-dashed border-teal-200" aria-hidden />
          </div>
      ...
      {/* Testimonials */}
      <section className="border-b border-slate-100 bg-[#FFFFFF] py-16 md:py-24">
        <div className={t.max}>
      ...
      >
        ...
        <div className={`${t.max} relative z-10 text-center`}>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              to="/register"
              className={`inline-flex min-w-[200px] items-center justify-center rounded-xl bg-white px-8 py-3 text-base font-semibold text-teal-700 ${t.transition} hover:scale-[1.02] active:scale-[0.98]`}
            >
              Create free account
            </Link>
            <Link
              to="/login"
              className={`inline-flex min-w-[200px] items-center justify-center rounded-xl border-2 border-white px-8 py-3 text-base font-semibold text-white ${t.transition} hover:scale-[1.02] hover:bg-white/10 active:scale-[0.98]`}
            >
              Sign in
            </Link>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-[#0F172A] pb-10 pt-16 text-slate-300">
        <div className={`${t.max} grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4`}>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                <a href="#features" className="text-slate-300 transition-colors hover:text-white">
                  Features
                </a>
              </li>
              <li>
                <Link to="/register" className="text-slate-300 transition-colors hover:text-white">
                  Pricing / Sign up
                </Link>
              </li>
              <li>
